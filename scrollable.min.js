 ...
 * License: MIT
 */
function(a){"use strict";a.module("angular-momentum-scroll",[]),a.module("angular-momentum-scroll").directive("scrollable",["$timeout","$window","$document",function(b,c,d){return{restrict:"AE",scope:{scrollToPageTime:"@",currPageX:"=",currPageY:"=",currY:"=",currX:"=",isMaxX:"=",isMinX:"=",isMaxY:"=",isMinY:"=",onRefresh:"&",onBeforeScrollStart:"&",onScrollStart:"&",onBeforeScrollMove:"&",onScrollMove:"&",parameters:"@",onBeforeScrollEnd:"&",onScrollEnd:"&",onTouchEnd:"&",onDestroy:"&",onZoomStart:"&",onZoom:"&",onZoomEnd:"&"},transclude:!0,template:'<div class="scroller" ng-transclude></div>',link:function(e,f,g){var h=".inline-flex {  display: -webkit-inline-flex;  display: -moz-inline-flex;  display: -ms-inline-flexbox;  display: -ms-inline-flex;  display: inline-flex;  display: -webkit-inline-box;  overflow: hidden;  white-space: nowrap;}.inline-flex > * {  display: block;}",i=a.element(d[0].head);i.append('<style type="text/css">'+h+"</style>"),f.css("overflow","hidden"),f.css("position","relative");var j,k=a.element(f.children(".scroller")[0]),l=function(){b(function(){a.isDefined(e.currY)&&(e.currY=j.y),a.isDefined(e.isMaxY)&&(e.isMaxY=j.y<=j.maxScrollY),a.isDefined(e.isMinY)&&(e.isMinY=j.y>=0),a.isDefined(e.currX)&&(e.currX=j.x),a.isDefined(e.isMaxX)&&(e.isMaxX=j.x<=j.maxScrollX),a.isDefined(e.isMinX)&&(e.isMinX=j.x>=0),a.isDefined(j.currentPage)&&(a.isDefined(e.currPageY)&&(e.currPageY=j.currentPage.pageY),a.isDefined(e.currPageX)&&(e.currPageX=j.currentPage.pageX));var b={pageX:a.isDefined(j.currentPage)?j.currentPage.pageX:void 0,pageY:a.isDefined(j.currentPage)?j.currentPage.pageY:void 0,X:j.x,Y:j.y};e.onScrollEnd(b)})},m=function(b){a.isDefined(j.pages)&&0!==j.pages.length&&a.isDefined(b)&&j.goToPage(b,0,e.scrollToPageTime)},n=function(b){a.isDefined(j.pages)&&0!==j.pages.length&&a.isDefined(b)&&j.goToPage(0,b,e.scrollToPageTime)},o=function(b){a.isDefined(b)&&j.scrollTo(0,b,e.scrollToPageTime)},p=function(b){a.isDefined(b)&&j.scrollTo(b,0,e.scrollToPageTime)},q="onorientationchange"in c,r=q?"orientationchange":"resize",s={},t=function(){(s.width!==screen.width||s.height!==screen.height)&&(s={width:screen.width,height:screen.height},a.isDefined(j)&&j.refresh())},u=function(){a.isDefined(j)&&(c.removeEventListener(r,t,!1),j.destroy(),j=void 0)},v=function(){u(),j=new IScroll(f[0],e.iscrollParameters);for(var b in e)if(-1!==b.indexOf("on")&&e.hasOwnProperty(b)&&a.isFunction(e[b])){var d=b.substring(2).charAt(0).toLowerCase()+b.substring(2).slice(1);if("scrollEnd"===d)continue;j.on(d,e[b])}j.on("scrollEnd",l),e.$watch("currPageY",n),e.$watch("currPageX",m),e.$watch("currY",o),e.$watch("currX",p),c.addEventListener(r,t,!1),f.bind("$destroy",function(){a.isDefined(j)&&u()})};g.$observe("parameters",function(b){e.iscrollParameters=a.isString(b)?a.fromJson(b):b,e.scrollX="scrollX"in e.iscrollParameters&&e.iscrollParameters.scrollX,e.scrollX&&k.addClass("inline-flex"),e.iscrollParameters.click=a.isDefined(b.click)?b.click:!0});var w=function(c){a.isDefined(c)&&b(function(){v(),a.isDefined(j.pages)&&j.pages.length>0&&(m(c.currPageX),n(c.currPageY))})};e.$watch(function(){return k[0].offsetHeight},w),e.$watch(function(){return k[0].offsetWidth},w),w()}}}])}(angular);
